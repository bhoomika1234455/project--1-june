# -*- coding: utf-8 -*-
"""
Created on Wed Jun  1 18:39:09 2022
@author: BHOOMIKA M
"""
...
def load_model():
    ...
    scrappedReviews = pd.read_csv("C:\\Users\\BHOOMIKA M\\Downloads\\scrappedReviews (1).csv")
  
    global pickle_model
    file = open("C:\\Users\\BHOOMIKA M\Downloads\\pickle_model.pkl", 'rb') 
    pickle_model = pickle.load(file)

    global vocab
    file = open("C:\\Users\\BHOOMIKA M\\Downloads\\features.pkl", 'rb') 
    ...
    plt.savefig(  "C:\\Users\\BHOOMIKA M\\Downloads\\assests\\sentiment1.png")
#word cloud
    ...
    cloud.to_file("C:\\Users\\BHOOMIKA M\\Downloads\\assests\\wordcloud1.png")
    #drop down
